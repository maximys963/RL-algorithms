...
function getInput() {
    ...
    const Dmilus = [[0,1,1,0],[0,0,0,1],[0,0,1,0]];
    const Dplus = [[1,0,0,0],[0,2,1,0],[0,0,0,1]];
    const Mi = [1,0,1,2];
   ...
   let Estart = [0,0,1];
    ...
    console.log(`(${Mi}) + (${Estart}) * (${D})`);
    console.log(`(${Mi}) + (${M})`);
    console.log(`(${M1Plus}) + (${E2start}) * (${D})`);
    console.log(`(${M1Plus}) + (${M1})`);
    console.log(`(${M2Plus}) + (${E3start}) * (${D})`);
    console.log(`(${M2Plus}) + (${M2})`);
    console.log(`(${M3Plus}) + (${E4start}) * (${D})`);
    console.log(`(${M3Plus}) + (${M3})`);
    console.log(`(${M4Plus}) + (${E5start}) * (${D})`);
    console.log(`(${M4Plus}) + (${M4})`);
